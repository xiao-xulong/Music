<template>
  <div>
    ...
    <article>
      ...
      <song_list @click="play_music(item.id,item.songName)" v-for="item in new_musics" :key="item.id" :Id="item.id"  :Name="item.songName" :SingerName="item.singer"></song_list>
...
<script>
  import {pics} from '../request/axios'
