<template>
  <div>
    <van-swipe ref="swipe" :autoplay="3000" class="swiper_container">
    ...
    <nav>
      ...
      <ul class="songlist">
        <li v-for="item in songlist" :key="item.id" @click="play_music(item.id,item.name)">
          <img :src="item.pic">
    ...
    <article>
      ...
      <song_list @click="play_music(item.id,item.songName)" v-for="item in new_musics" :key="item.id" :Id="item.id"
        :Name="item.songName" :SingerName="item.singer"></song_list>
      <!--      <ul class="new_music" v-for="item in new_musics" :key="item.id" @click="play_music(item.id,item.songName)">-->
      <!--        <li  >-->
      <!--          <div class="new_music_info">-->
      <!--            <div  class="new_music_name">-->
      <!--             {{item.songName}}-->
      <!--            </div>-->
      <!--            <div  class="new_music_singer">-->
      <!--            <i class="sq"></i>-->
      <!--              {{item.singer}}-->
      <!--            </div>-->
      <!--          </div>-->
      <!--          <div class="new_music_icon">-->
      <!--            <span></span>-->
      <!--          </div>-->
      <!--        </li>-->
      <!--      </ul>-->
...
article {
  ...
  /*              width: 12px;*/
  /*              height: 8px;*/
  /*              background-image: url("http://s3.music.126.net/mobile-new/img/index_icon_2x.png?5207a28c3767992ca4bb6d4887c74880=)");*/
  ...
  /*        .new_music_icon{*/
  /*flex: 1;*/
  /*          !*http://s3.music.126.net/mobile-new/img/index_icon_2x.png?5207a28c3767992ca4bb6d4887c74880=)*!*/
  /*          span{*/
  /*            position: relative;*/
  /*            top: 50%;*/
  /*            left: 50%;*/
